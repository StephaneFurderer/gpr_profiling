...
# Initializing Jinja
pl = PackageLoader('gpr_profiling', 'templates')
...
messages['HIGH_CARDINALITY'] = u'{0[varname]} has a high cardinality: {0[distinct_count]} distinct values  <span class="label label-warning">Warning</span>'
...
messages['skewness'] = u'{0[varname]} is highly skewed (γ1 = {0[skewness]})  <span class="label label-info">Skewed</span>'
messages['p_missing'] = u'{0[varname]} has {0[n_missing]} / {0[p_missing]} missing values <span class="label label-default">Missing</span>'
messages['p_infinite'] = u'{0[varname]} has {0[n_infinite]} / {0[p_infinite]} infinite values <span class="label label-default">Infinite</span>'
messages['p_zeros'] = u'{0[varname]} has {0[n_zeros]} / {0[p_zeros]} zeros <span class="label label-info">Zeros</span>'

messages['check-passed'] = u'{name} is {val} <span class="label label-success">OK</span>'
messages['check-warning'] = u'{name} is {val} <span class="label label-warning">Warning</span>'
messages['check-error'] = u'{name} value in unsupported metric format <span class="label label-danger">Data Error</span>'
messages['list-warning'] = u'{name} has {val} entries <span class="label label-warning">Warning</span>'
messages['list-passed'] = u'{name} has {val} entries <span class="label label-success">OK</span>'

message_row = u'<li>{message}</li>'

gpr_metric_row = u'<tr><th>{name}</th><td>{formatted_values}</td></tr>'
gpr_desc_row = u'<tr><th>{name}</th><td>{desc}</td></tr>'